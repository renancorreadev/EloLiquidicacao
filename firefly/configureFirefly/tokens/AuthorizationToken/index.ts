...
} from "../../../deployFirefly/types/firefly";
...
interface AuthorizationContractEventListener {
    eventName: string,
    topic: string
}


const AuthorizationTokenABI = AuthorizationToken__factory.abi;

export class ConfigureAuthorizationToken {
    host: string;
    host_port: string;

    private participantAuthorizationContractAddress: string = "";
    ...
    constructor(host: string, port: string, participantAuthorizationAddress: string) {
        this.host = host;
        this.host_port = port;
        this.participantAuthorizationContractAddress = participantAuthorizationAddress
    }
    ...
    async makeGenerateContractAPIRequest(name: string): Promise<GenerateContractAPIResponseType> {
        ...
        const payload: GenerateContractAPIBodyType = {
            ...
            location: {
                address: this.participantAuthorizationContractAddress
            }
        }
   ...
   */
    async makeGenerateEventListener(params: AuthorizationContractEventListener): Promise<GenerateContractEventListenerResponseType> {
